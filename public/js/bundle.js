...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWxlbmExOTg3IiwiYSI6ImNrc29ndzdvaDBpbW8yb25wbDFpbzNuOGcifQ.I0IRMwGfdE28-6UjfwSrGg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/elena1987/cksohjpf33e0j18pgl36huy41' // center: [-118.113491, 34.111745],
    // zoom: 10,
    // interactive: false
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JScgfKVMytq9VQAvBY1b44CYDSKCRf7QJIpWdIebKGQN4J0eZJd328cRgozYZcqvHv03IWLgy83p1Mg5lIMiEi400dcCrGKvQ'); // 1) Get checkout session from API
